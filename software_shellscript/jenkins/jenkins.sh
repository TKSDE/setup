...
# Set up Docker repository and install Docker CLI (for Ubuntu)

#sudo curl -fsSL [https://get.docker.com](https://get.docker.com/) | sh
...
sudo docker run -u root --name jenkins-docker --rm --detach --privileged \
...
--env DOCKER_TLS_VERIFY=1 --publish 8081:8080 --publish 50000:50000 \
